...
const QUEUE = [
  ...
  // 13 ties x 2 ends x 453 mm. These are now PRIMARY SUPPORTS, not wind braces
  // - see params.kneeBraces._STRUCTURAL. The timber is still free; the seat cut
  // is the cost.
  { group: 'kneeBraces',      section: '50x100_m', boards: 11.8 },
