...
const QUEUE = [
  ...
  // 16 short at 1.495 + 16 bolsters at 0.30 + 16 TALL at 1.795 + 4 gable
  // posts. The tall ones are the new cost — 28.7 m for roll restraint and
  // an X-brace anchor. 50 x 100 spare drops to about 10 m.
  { group: 'purlinVerticals', section: '50x100_m', boards: 64.8 },
