...
| 100 × 100 × 6 m | 16 | 0 | **16** |
| 50 × 100 | 120.4 m | 228 m from the rafter rip | **0** |
...
| **TOTAL** | | **229** | **1,374** | | | **4.350** | **1,114.47** | **€1,348.50** |

€234.03 of that is VAT. **Budget €1,348.50 all in.**

Down €18.60 from the 576 mm setout, and it nets out from two opposite moves: 9 fewer
25 × 50 because there are four fewer rafter lines to counter-batten, against 2 more
25 × 100 because a 6 m batten now wastes 400 mm per board instead of 240. The ties and
rafters come out of stock either way, so the 8 boards saved there show up as spare,
not as money.
...
| 50 × 100 | 120.4 m | 228 m | all from the rafter rip — blocking, spacers, collars, verticals |
